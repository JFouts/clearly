...
public class MultiSelectEditorAttribute : PropertyDefinitionNodeAttribute
{
    private readonly string options;

    /// <summary>
    /// Sets the Editor Component for this Property in the Admin to use a Multi-Select Editor.
    /// </summary>
    /// <param name="options">A static set of options in the for of key value pairs. ex. "key1,value1;key2,value2"</param>
    public MultiSelectEditorAttribute(string options)
    {
